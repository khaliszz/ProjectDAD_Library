...
public class LibraryMember extends JFrame {
	...
	public LibraryMember(int memberId) {
		...
		btnSearch.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    String urlString = "http://10.131.73.130/projectDAD/LibraryServer.php?action=searchBookByTitle"
                            + "&title=" + encodedTitle;
		...
		String urlString = "http://10.131.73.130/projectDAD/LibraryServer.php?action=retrieve";
		try {
		    URL url = new URL(urlString);
		    HttpURLConnection conn = (HttpURLConnection) url.openConnection();
		    conn.setRequestMethod("GET");
	...
	private void sendBorrowRequest(String title, String isbn, String dateBorrowed, String status, int memberID) {
		 ...
		 try {
			 String encodedTitle = URLEncoder.encode(title, "UTF-8");
		        ...
		        {
		        	JOptionPane.showMessageDialog(frame, "You have already borrow 3 books. Please return them before borrowing another book", "Error", JOptionPane.WARNING_MESSAGE);
		        }
		        else
		        {
