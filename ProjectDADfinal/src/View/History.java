...
public class History extends JFrame {
        ...
        btnSearchHistory.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    String urlString = "http://10.131.73.130/projectDAD/LibraryServer.php?action=getReturnedBooksHistory"
    ...
    private void loadReturnedBooksHistory() {
        String urlString = "http://10.131.73.130/projectDAD/LibraryServer.php?action=getAllReturnedBooksHistory";
        try {
            URL url = new URL(urlString);
            HttpURLConnection conn = (HttpURLConnection) url.openConnection();
            conn.setRequestMethod("GET");
