...
public class StaffLibrary extends JFrame{
		...
		btnSearchBook.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    String urlString = "http://10.131.73.130/projectDAD/LibraryServer.php?action=searchBorrowedBook"
                            + "&title=" + encodedTitle;
		...
		btnSearchID.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    String urlString = "http://10.131.73.130/projectDAD/LibraryServer.php?action=searchBorrowedBookByID"
                            + "&memberID=" + encodedID;
	...
	private void loadBorrowedBooks() {
        String urlString = "http://10.131.73.130/projectDAD/LibraryServer.php?action=retrieveBorrowedBooks";
        try {
            URL url = new URL(urlString);
            HttpURLConnection conn = (HttpURLConnection) url.openConnection();
            conn.setRequestMethod("GET");
