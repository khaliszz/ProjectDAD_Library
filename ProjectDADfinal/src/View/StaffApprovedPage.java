...
public class StaffApprovedPage extends JFrame {
	...
	private void initialize() {
		...
		lblNewLabel_1.setIcon(new ImageIcon("C:\\Users\\Khalis\\eclipse-workspace\\ProjectDAD\\src\\images\\Logo-Universiti-Teknikal-Malaysia-Melaka-UTeM-Jawi-new-300x300 (1).png"));
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
		        ...
		        if (selectedRows.length == 0) {
		            JOptionPane.showMessageDialog(frame, "Please select at least one member to approve.", "No Selection", JOptionPane.WARNING_MESSAGE);
		            return;
		        }
		...
		buttonReject.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
		        ...
		        for (int i : selectedRows) {
		            ...
		            System.out.println("Selected Book - Member ID: " + memberID + ", Username: " + username + ", Password: " + password);
	...
	private void loadPendingMember() {
	    String urlString = "http://10.131.73.130/projectDAD/LibraryServer.php?action=retrievePendingMember";
	    try {
	...
	private void giveApproval(int memberID, String username, String password) {
		 ...
		 try {
			 String encodedName = URLEncoder.encode(username, "UTF-8");
		        String urlString = "http://10.131.73.130/projectDAD/LibraryServer.php"
		                         + "?action=approvedMember"
		                         + "&memberID=" + memberID
